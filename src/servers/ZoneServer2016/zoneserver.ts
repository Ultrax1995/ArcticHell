...
export class ZoneServer2016 extends EventEmitter {
  ...
  async start(): Promise<void> {
    ...
    this.hook("OnServerReady", () => {
  //new RespawnManager(this).init();
});
  }
  ...
  giveDefaultEquipment(
    ...
    this.equipItem(client, this.generateItem(Items.BACKPACK_RASTA), sendPacket); // fists weapon
    this.equipItem(client, this.generateItem(2795), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(2889), sendPacket); // twitch Hoodie
    this.equipItem(client, this.generateItem(3875), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(2261), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(2795), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(Items.WEAPON_308), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(58), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(Items.WEAPON_308), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(Items.KEVLAR_DEFAULT), sendPacket); // golf pants
    this.equipItem(client, this.generateItem(2045), sendPacket); // golf pants
  }
  giveDefaultItems(client: Client, sendPacket: boolean) {
    ...
    this.lootContainerItem(client, this.generateItem(Items.FIRST_AID), 10, sendPacket);
    this.lootContainerItem(client, this.generateItem(Items.AMMO_308), 50, sendPacket);
    this.lootContainerItem(client, this.generateItem(Items.BANDAGE_DRESSED), 10, sendPacket);
    this.lootContainerItem(client, this.generateItem(2045), 1, sendPacket);
  ...
  giveBuildItems(client: Client) {
    this.lootItem(client, this.generateItem(1, 1));
    this.lootItem(client, this.generateItem(141, 500));
    this.lootItem(client, this.generateItem(109, 500));
	this.lootItem(client, this.generateItem(46, 500));
	this.lootItem(client, this.generateItem(48, 500));
	this.lootItem(client, this.generateItem(135, 1000));
	this.lootItem(client, this.generateItem(111, 500));
	this.lootItem(client, this.generateItem(16, 200));
  }
